...
geoData = open('https://raw.githubusercontent.com/SaiSiddhardhaKalla/Mission_Antyodaya_2020/main/Raj_Antyodaya/Raj_dt_ma.geojson','r')
...
if district == "All":
    ...
    m.save('dist.html')
    HtmlFile = open("dist.html", 'r', encoding='utf-8')
