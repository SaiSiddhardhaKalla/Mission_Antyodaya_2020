...
#geo_gc_data = pd.read_csv("raj_gp_ma.csv")
...
if district == "All":
    ...
    if assembly_const == "None":
        ...
        m = folium.Map(location=[list((new_gc_data.iloc[0]['geometry']).coords)[0][1], list((new_gc_data.iloc[0]['geometry']).coords)[0][0]],zoom_start=7, tiles='cartodbpositron')
